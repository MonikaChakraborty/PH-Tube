      ...
      // console.log(time);
        ...
        <div class="card-body">
          ...
          <div class="flex gap-2 w-[200px]">
            <p class="ml-16 text-sm text-slate-600 border border-red-400">${videos?.authors[0]?.profile_name}</p>
            <p class="text-sm text-slate-600 border border-red-400">${videos?.authors[0]?.verified ? `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
